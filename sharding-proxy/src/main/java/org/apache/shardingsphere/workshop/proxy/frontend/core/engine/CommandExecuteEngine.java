...
package org.apache.shardingsphere.workshop.proxy.frontend.core.engine;
...
public interface CommandExecuteEngine {
     ...
     */
    CommandPacket getCommandPacket(PacketPayload payload, CommandPacketType type) throws SQLException;
     ...
     */
    CommandExecutor getCommandExecutor(CommandPacketType type, CommandPacket packet);
     ...
     * @throws SQLException SQL exception
     */
    void writeQueryData(ChannelHandlerContext context, QueryCommandExecutor queryCommandExecutor, int headerPackagesCount) throws SQLException;
}
