...
package org.apache.shardingsphere.workshop.proxy.frontend.mysql.command.query.text.query;

import org.apache.shardingsphere.workshop.proxy.backend.response.BackendResponse;
import org.apache.shardingsphere.workshop.proxy.backend.response.error.ErrorResponse;
...
import org.apache.shardingsphere.workshop.proxy.backend.text.TextProtocolBackendHandler;
import org.apache.shardingsphere.workshop.proxy.backend.text.TextProtocolBackendHandlerFactory;
...
import org.apache.shardingsphere.workshop.proxy.transport.mysql.constant.MySQLColumnType;
import org.apache.shardingsphere.workshop.proxy.transport.mysql.packet.MySQLPacket;
import org.apache.shardingsphere.workshop.proxy.transport.mysql.packet.command.query.MySQLColumnDefinition41Packet;
import org.apache.shardingsphere.workshop.proxy.transport.mysql.packet.command.query.MySQLColumnFieldDetailFlag;
import org.apache.shardingsphere.workshop.proxy.transport.mysql.packet.command.query.MySQLFieldCountPacket;
import org.apache.shardingsphere.workshop.proxy.transport.mysql.packet.command.query.text.MySQLTextResultSetRowPacket;
import org.apache.shardingsphere.workshop.proxy.transport.mysql.packet.command.query.text.query.MySQLComQueryPacket;
import org.apache.shardingsphere.workshop.proxy.transport.mysql.packet.generic.MySQLEofPacket;
import org.apache.shardingsphere.workshop.proxy.transport.mysql.packet.generic.MySQLErrPacket;
...
public final class MySQLComQueryPacketExecutor implements QueryCommandExecutor {
    ...
    public MySQLComQueryPacketExecutor(final MySQLComQueryPacket comQueryPacket) {
        textProtocolBackendHandler = TextProtocolBackendHandlerFactory.newInstance(comQueryPacket.getSql());
    }
