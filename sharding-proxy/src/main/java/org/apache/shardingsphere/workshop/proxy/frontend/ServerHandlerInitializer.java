...
import org.apache.shardingsphere.workshop.proxy.frontend.mysql.MySQLProtocolFrontendEngine;
import org.apache.shardingsphere.workshop.proxy.transport.core.codec.PacketCodec;
...
public final class ServerHandlerInitializer extends ChannelInitializer<SocketChannel> {
    ...
    protected void initChannel(final SocketChannel socketChannel) {
        DatabaseProtocolFrontendEngine databaseProtocolFrontendEngine = new MySQLProtocolFrontendEngine();
